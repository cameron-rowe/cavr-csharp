...
namespace cavr.math
{
    public class HomogeneousMatrixBasef : IEquatable<HomogeneousMatrixBasef>, ICloneable
    {
        ...
        public static implicit operator float[] (HomogeneousMatrixBasef mat) {
            return mat.values.Cast<float>().ToArray();
        }
    }
    ...
    public class Matrix4f : HomogeneousMatrixBasef, ICopyable<Matrix4f>
    {
        ...
        public void SetRow(int index, Vector4f val) {
            values[index, 0] = val.x;
            values[index, 1] = val.y;
            values[index, 2] = val.z;
            values[index, 3] = val.w;
        }

        // Code used and slightly modified from
        ...
        public Matrix4f Inverse() {
            ...
            if(det == 0) {
                throw new ArithmeticException("Matrix determinite cannot be 0");
            }
    ...
    public class HomogeneousMatrixBased : IEquatable<HomogeneousMatrixBased>, ICloneable
    {
        ...
        public static implicit operator double[] (HomogeneousMatrixBased mat) {
            return mat.values.Cast<double>().ToArray();
        }
    }
    ...
    public class Matrix4d : HomogeneousMatrixBased, ICopyable<Matrix4d>
    {
        ...
        public void SetRow(int index, Vector4d val) {
            values[index, 0] = val.x;
            values[index, 1] = val.y;
            values[index, 2] = val.z;
            values[index, 3] = val.w;
